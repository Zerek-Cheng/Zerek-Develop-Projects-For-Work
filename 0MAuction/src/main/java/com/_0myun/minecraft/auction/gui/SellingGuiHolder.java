...
@Data
public class SellingGuiHolder implements InventoryHolder {
    String player;
    Inventory inv;
    ...
    public void init() {
        ...
        List<Orders> orders = OrderManager.list(this.player, Arrays.asList(0, 1));
        ...
        inv.setItem(49, ConfigUtils.getConfigItem("gui.button.page-selling-shelves"));
