...
public class CmdNoppes extends ChMcLogger
{
    ...
    public boolean npc(String[] args) {
        ...
        final int x = this.pcParam.getCommandSenderPosition().posX;
        final int y = this.pcParam.getCommandSenderPosition().posY;
        final int z = this.pcParam.getCommandSenderPosition().posZ;
