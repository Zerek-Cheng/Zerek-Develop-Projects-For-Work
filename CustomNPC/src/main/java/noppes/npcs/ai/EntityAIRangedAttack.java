...
public class EntityAIRangedAttack extends EntityAIBase
{
    ...
    public void updateTask() {
        ...
        final float maxAttackDistance = this.entityHost.stats.rangedRange * this.entityHost.stats.rangedRange;
        if (!this.navOverride && this.entityHost.ai.directLOS) {
            ...
            if (var1 <= maxAttackDistance && this.field_75318_f >= v) {
                this.entityHost.getNavigator().clearPathEntity();
            }
            else {
        ...
        if (this.rangedAttackTime <= 0 && var1 <= maxAttackDistance && (this.entityHost.getEntitySenses().canSee((Entity)this.attackTarget) || this.entityHost.ai.canFireIndirect == 2)) {
            ...
            if (this.field_70846_g > 1) {
                ...
                switch (this.entityHost.ai.canFireIndirect) {
                    case 1: {
                        indirect = (var1 > maxAttackDistance / 2.0);
                        break;
                    }
                    case 2: {
