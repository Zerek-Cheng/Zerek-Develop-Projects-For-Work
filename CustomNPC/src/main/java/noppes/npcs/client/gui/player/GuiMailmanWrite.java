...
public class GuiMailmanWrite extends GuiContainerNPCInterface implements ITextfieldListener, IGuiError, IGuiClose, GuiYesNoCallback
{
    ...
    private void func_74159_a(final String par1Str) {
        if (this.bookPages != null && this.currPage >= 0 && this.currPage < this.bookPages.tagCount()) {
            this.bookPages.setTag(this.currPage, (NBTBase)new NBTTagString(par1Str));
        }
    }
    ...
    private void func_74160_b(final String par1Str) {
        ...
        final int i = this.mc.fontRendererObj.splitStringWidth(s2 + "" + EnumChatFormatting.BLACK + "_", 118);
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        final int l = this.mc.fontRendererObj.getStringWidth(s);
        this.mc.fontRendererObj.drawString(s, this.guiLeft - l + this.bookImageWidth - 44, this.guiTop + 18, 0);
        this.mc.fontRendererObj.drawSplitString(s2, this.guiLeft + 36, this.guiTop + 18 + 16, 116, 0);
