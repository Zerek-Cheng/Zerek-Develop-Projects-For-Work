...
public class GuiNpcCompanionTalents extends GuiNPCInterface
{
    ...
    public void actionPerformed(final GuiButton guibutton) {
        ...
        if (id >= 10) {
            ...
            final long getWorldTime = this.mc.theWorld.getWorldTime();
    ...
    public void drawScreen(final int i, final int j, final float f) {
        ...
        this.mc.fontRendererObj.drawString(s, this.guiLeft + this.xSize / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2, this.guiTop + 10, CustomNpcResourceListener.DefaultTextColor);
    ...
    public static class GuiTalent extends GuiScreen
    {
        ...
        public void drawScreen(final int i, final int j, final float f) {
            ...
            GuiTalent.itemRender.renderItemAndEffectIntoGUI(mc.fontRendererObj, mc.getTextureManager(), item, this.x + 4, this.y + 4);
            GuiTalent.itemRender.renderItemOverlayIntoGUI(mc.fontRendererObj, mc.getTextureManager(), item, this.x + 4, this.y + 4);
