...
public class GuiQuestLog extends GuiNPCInterface implements ITopButtonListener, ICustomScrollListener, IGuiData
{
    ...
    public void drawScreen(final int i, final int j, final float f) {
        ...
        if (this.questDetails) {
            ...
            this.mc.fontRendererObj.drawString(title, this.guiLeft + 284 - this.mc.fontRendererObj.getStringWidth(title), this.guiTop + 179, CustomNpcResourceListener.DefaultTextColor);
        }
        else {
            this.drawQuestText();
            final String title = StatCollector.translateToLocal("quest.objectives");
            this.mc.fontRendererObj.drawString(title, this.guiLeft + 168, this.guiTop + 179, CustomNpcResourceListener.DefaultTextColor);
        }
        GL11.glPushMatrix();
