...
public class ModelCouchWoodRight extends ModelBase
{
    ...
    public ModelCouchWoodRight() {
        (this.Shape1 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 3, 10);
        ...
        (this.Shape3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 1);
        this.Shape3.setRotationPoint(6.0f, 14.0f, 0.5f);
        (this.Shape4 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 1);
        this.Shape4.setRotationPoint(-8.0f, 7.0f, 7.0f);
        (this.Shape5 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 2);
        this.Shape5.setRotationPoint(-8.0f, 19.0f, 6.0f);
        (this.Shape6 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 13);
        ...
        (this.Shape11 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 14, 2, 2);
        ...
        (this.Shape17 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 10, 2);
        this.Shape17.setRotationPoint(6.0f, 14.0f, -6.0f);
        (this.Shape18 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 18, 2);
