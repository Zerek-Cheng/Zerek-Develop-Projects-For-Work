...
public class ModelCouchWoodSingle extends ModelBase
{
    ...
    public ModelCouchWoodSingle() {
        ...
        (this.Shape4 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 12, 2, 1);
        this.Shape4.setRotationPoint(-6.0f, 7.0f, 7.0f);
        (this.Shape5 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 12, 2, 2);
        ...
        (this.Shape9 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 10);
        ...
        (this.Shape11 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 12, 2, 2);
        ...
        (this.Shape16 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 10, 1);
        this.Shape16.setRotationPoint(5.0f, 9.0f, 7.0f);
        (this.Shape17 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 18, 2);
        this.Shape17.setRotationPoint(6.0f, 6.0f, 6.0f);
        (this.Shape18 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 1, 13);
        this.Shape18.setRotationPoint(6.0f, 13.0f, -7.0f);
        (this.Shape19 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 10, 2);
        this.Shape19.setRotationPoint(6.0f, 14.0f, -6.0f);
        (this.Shape20 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 3, 10);
        this.Shape20.setRotationPoint(6.0f, 18.0f, -4.0f);
        (this.Shape21 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 4, 1);
