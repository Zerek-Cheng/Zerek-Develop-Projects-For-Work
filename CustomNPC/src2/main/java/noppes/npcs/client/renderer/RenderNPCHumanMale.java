...
public class RenderNPCHumanMale extends RenderNPCInterface
{
    ...
    public void renderPlayer(final EntityNPCInterface npc, final double d, final double d1, final double d2, final float f, final float f1) {
        ...
        final boolean isSneaking = npc.isSneaking();
        modelBipedMain3.isSneak = isSneaking;
        modelArmor3.isSneak = isSneaking;
        modelArmorChestplate3.isSneak = isSneaking;
        ...
        final boolean isPlayerSleeping = npc.isPlayerSleeping();
        ...
        final boolean isRiding = npc.isRiding();
        modelBipedMain7.isRiding = isRiding;
        modelArmor7.isRiding = isRiding;
        modelArmorChestplate7.isRiding = isRiding;
    ...
    protected void renderSpecials(final EntityNPCInterface npc, final float f) {
        ...
        if (itemstack2 != null) {
            ...
            if (itemstack2.getItem().requiresMultipleRenderPasses()) {
                for (int var8 = 0; var8 < itemstack2.getItem().getRenderPasses(itemstack2.getMetadata()); ++var8) {
