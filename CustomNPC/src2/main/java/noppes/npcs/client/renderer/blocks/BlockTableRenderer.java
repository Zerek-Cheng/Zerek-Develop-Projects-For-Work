...
public class BlockTableRenderer extends BlockRendererInterface
{
    ...
    public void renderTileEntityAt(final TileEntity var1, final double var2, final double var4, final double var6, final float var8) {
        ...
        final boolean south = var1.getWorld().getBlock(var1.xCoord + 1, var1.yCoord, var1.zCoord) == CustomItems.table;
        final boolean north = var1.getWorld().getBlock(var1.xCoord - 1, var1.yCoord, var1.zCoord) == CustomItems.table;
        final boolean east = var1.getWorld().getBlock(var1.xCoord, var1.yCoord, var1.zCoord + 1) == CustomItems.table;
        final boolean west = var1.getWorld().getBlock(var1.xCoord, var1.yCoord, var1.zCoord - 1) == CustomItems.table;
