...
public class StringCache
{
    ...
    private void cacheDightGlyphs() {
        ...
        this.digitGlyphs[1] = this.cacheString("¡ìl0123456789").glyphs;
        this.digitGlyphs[2] = this.cacheString("¡ìo0123456789").glyphs;
        this.digitGlyphs[3] = this.cacheString("¡ìl¡ìo0123456789").glyphs;
