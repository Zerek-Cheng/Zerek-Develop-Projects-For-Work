...
public class EntityProjectile extends EntityThrowable
{
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            MovingObjectPosition movingobjectposition = this.worldObj.rayTraceBlocks(vec3, vec4, false, true, false);
            ...
            if (!this.worldObj.isRemote) {
                ...
                for (int k = 0; k < list.size(); ++k) {
                    final Entity entity2 = list.get(k);
    ...
    public EntityLivingBase getThrower() {
        ...
        try {
            ...
            if (this.thrower == null && uuid != null) {
                this.thrower = (EntityLivingBase)this.worldObj.getPlayerEntityByUUID(uuid);
            }
        }
