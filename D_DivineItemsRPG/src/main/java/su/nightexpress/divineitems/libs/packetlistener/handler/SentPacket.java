...
extends PacketAbstract {
    public SentPacket(Object object, Cancellable cancellable, Player player) {
        super(object, cancellable, player);
    }

    public SentPacket(Object object, Cancellable cancellable, ChannelWrapper channelWrapper) {
