 ...
 *  net.minecraft.server.v1_10_R1.EntityPlayer
 *  net.minecraft.server.v1_10_R1.IChatBaseComponent
 *  net.minecraft.server.v1_10_R1.IChatBaseComponent$ChatSerializer
 *  net.minecraft.server.v1_10_R1.ItemStack
 *  net.minecraft.server.v1_10_R1.NBTBase
 *  net.minecraft.server.v1_10_R1.NBTTagCompound
 *  net.minecraft.server.v1_10_R1.NBTTagDouble
 *  net.minecraft.server.v1_10_R1.NBTTagInt
 *  net.minecraft.server.v1_10_R1.NBTTagList
 *  net.minecraft.server.v1_10_R1.NBTTagString
 *  net.minecraft.server.v1_10_R1.Packet
 *  net.minecraft.server.v1_10_R1.PacketPlayOutChat
 *  net.minecraft.server.v1_10_R1.PacketPlayOutTitle
 *  net.minecraft.server.v1_10_R1.PacketPlayOutTitle$EnumTitleAction
 *  net.minecraft.server.v1_10_R1.PlayerConnection
 *  org.bukkit.ChatColor
 *  org.bukkit.craftbukkit.v1_10_R1.entity.CraftPlayer
...
implements NMS {
    ...
    public ItemStack setNBTAtt(ItemStack itemStack, NBTAttribute nBTAttribute, double d) {
        net.minecraft.server.v1_10_R1.ItemStack itemStack2 = CraftItemStack.asNMSCopy((ItemStack)itemStack);
        ...
        itemStack = CraftItemStack.asBukkitCopy((net.minecraft.server.v1_10_R1.ItemStack)itemStack2);
        return itemStack;
    }
