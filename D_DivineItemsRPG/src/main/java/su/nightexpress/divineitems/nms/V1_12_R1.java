...
implements NMS {
    ...
    public ItemStack setNBTAtt(ItemStack itemStack, NBTAttribute nBTAttribute, double d) {
        net.minecraft.server.v1_12_R1.ItemStack itemStack2 = CraftItemStack.asNMSCopy((ItemStack)itemStack);
        ...
        itemStack = CraftItemStack.asBukkitCopy((net.minecraft.server.v1_12_R1.ItemStack)itemStack2);
        return itemStack;
    }
