 ...
 *  net.minecraft.server.v1_9_R1.IChatBaseComponent$ChatSerializer
 *  net.minecraft.server.v1_9_R1.ItemStack
 *  net.minecraft.server.v1_9_R1.NBTBase
 *  net.minecraft.server.v1_9_R1.NBTTagCompound
 *  net.minecraft.server.v1_9_R1.NBTTagDouble
 *  net.minecraft.server.v1_9_R1.NBTTagInt
 *  net.minecraft.server.v1_9_R1.NBTTagList
 *  net.minecraft.server.v1_9_R1.NBTTagString
 *  net.minecraft.server.v1_9_R1.Packet
 *  net.minecraft.server.v1_9_R1.PacketPlayOutChat
 *  net.minecraft.server.v1_9_R1.PacketPlayOutTitle
 *  net.minecraft.server.v1_9_R1.PacketPlayOutTitle$EnumTitleAction
...
implements NMS {
    @Override
    public org.bukkit.inventory.ItemStack setNBTAtt(org.bukkit.inventory.ItemStack itemStack, NBTAttribute nBTAttribute, double d) {
        ...
        itemStack = CraftItemStack.asBukkitCopy((ItemStack)itemStack2);
        return itemStack;
    }
