 ...
 *  net.minecraft.server.v1_9_R2.NBTBase
 *  net.minecraft.server.v1_9_R2.NBTTagCompound
 *  net.minecraft.server.v1_9_R2.NBTTagDouble
 *  net.minecraft.server.v1_9_R2.NBTTagInt
 *  net.minecraft.server.v1_9_R2.NBTTagList
 *  net.minecraft.server.v1_9_R2.NBTTagString
...
implements NMS {
    ...
    public ItemStack setNBTAtt(ItemStack itemStack, NBTAttribute nBTAttribute, double d) {
        net.minecraft.server.v1_9_R2.ItemStack itemStack2 = CraftItemStack.asNMSCopy((ItemStack)itemStack);
        ...
        itemStack = CraftItemStack.asBukkitCopy((net.minecraft.server.v1_9_R2.ItemStack)itemStack2);
        return itemStack;
    }
