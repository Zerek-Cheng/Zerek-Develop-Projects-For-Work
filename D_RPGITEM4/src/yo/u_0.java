...
extends w_1 {
    ...
    public u_0(int initialCapacity) {
        super(initialCapacity);
        this.c = 0;
        this.d = 0;
    }

    public u_0(int initialCapacity, float loadFactor) {
        super(initialCapacity, loadFactor);
        this.c = 0;
        this.d = 0;
    }

    public u_0(int initialCapacity, float loadFactor, int no_entry_key, int no_entry_value) {
        super(initialCapacity, loadFactor);
        this.c = no_entry_key;
