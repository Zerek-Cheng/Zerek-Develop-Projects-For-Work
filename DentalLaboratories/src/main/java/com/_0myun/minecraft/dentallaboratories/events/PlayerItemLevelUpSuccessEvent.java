...
public class PlayerItemLevelUpSuccessEvent extends Event {
    ...
    public PlayerItemLevelUpSuccessEvent(Player p, ItemStack item, int from, int to, HashMap<String, Integer> attributes) {
        this.player = p;
        this.item = item;
        this.from = from;
        this.to = to;
