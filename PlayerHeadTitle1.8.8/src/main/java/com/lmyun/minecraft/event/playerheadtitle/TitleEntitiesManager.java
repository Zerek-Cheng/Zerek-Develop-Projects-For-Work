...
public class TitleEntitiesManager {
    ...
    public Entity getL1() {
        return Main.getEntity(this.l1);
    }

    public Entity getL2() {
        return Main.getEntity(this.l2);
    }

    public Entity getL3() {
        return Main.getEntity(this.l3);
    }
    ...
    public boolean isKilled() {
        Entity entity = Main.getEntity(this.l1);
        Entity entity1 = Main.getEntity(this.l2);
        Entity entity2 = Main.getEntity(this.l3);
