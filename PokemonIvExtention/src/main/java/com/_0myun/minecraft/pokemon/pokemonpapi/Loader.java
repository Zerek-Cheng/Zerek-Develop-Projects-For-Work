...
import com._0myun.minecraft.pokemonivextention.Main;
...
public class Loader {
    ...
    public void onEnable() {
        ...
        try {
            ...
            getLogger().log(Level.INFO, "PokemonIvExtention_845008749 Loading");
            try {
                //主要验证步骤
    ...
    public void deal(int msgType, byte[] msg) {
        switch (msgType) {
            case 1001:
                ...
                licenseCheckPackage.setLicenseType("PokemonIvExtention_845008749");
