        ...
        extends AbstractEconomy
{
    ...
    {
        PlayerStorage account = CatPixelmonSync.instance.getPixelmonBankAccount(playerName);
        return account != null ? account.getCurrency() : 0;
    }
    ...
    public EconomyResponse withdrawPlayer(String playerName, double amount)
    {
        ...
        double balance = account.getCurrency();
        if (amount < 0.0D) {
        ...
        if (CatPixelmonSync.instance.changeMoney(account, (int)(amount * -1.0D))) {
            return new EconomyResponse(amount, account.getCurrency(), EconomyResponse.ResponseType.SUCCESS, "");
        }
        return new EconomyResponse(0.0D, balance, EconomyResponse.ResponseType.FAILURE, "");
    }
    ...
    public EconomyResponse depositPlayer(String playerName, double amount)
    {
        ...
        return new EconomyResponse(0.0D, account.getCurrency(), EconomyResponse.ResponseType.FAILURE, "");
    }
