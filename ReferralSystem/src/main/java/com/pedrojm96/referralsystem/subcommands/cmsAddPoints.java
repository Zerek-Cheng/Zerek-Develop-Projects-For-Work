...
public class cmsAddPoints
extends SubCommand {
    private String perm;

    public cmsAddPoints(String string) {
        this.perm = string;
    }
    ...
    public void onCommand(CommandSender commandSender, String[] arrstring) {
        ...
        if (arrstring.length < 3) {
            ...
            String string2 = Util.rColor("&a- " + Messages.Command_AddPoints_Use());
        ...
        if (!Util.isint(arrstring[2])) {
            ...
            String string3 = Util.rColor("&a- " + Messages.Command_AddPoints_Use());
            player.sendMessage(string);
        ...
        ReferralAPI.addPoints(offlinePlayer, (int)Integer.valueOf(arrstring[2]));
        String string = Util.rColor(Messages.Points_Added());
