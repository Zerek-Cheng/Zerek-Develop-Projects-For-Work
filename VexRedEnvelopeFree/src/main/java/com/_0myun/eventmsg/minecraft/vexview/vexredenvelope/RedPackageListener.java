...
public class RedPackageListener implements org.bukkit.event.Listener {
    ...
    public void onSendRedPackage(PlayerRedPackageSendEvent e) {
        ...
        VexImageShow vBg = new VexImageShow(1, ConfigManager.getConfig().getString("ui.hud.img")
        ...
        players.forEach((p) -> {
            ...
            titleLists.forEach((str) -> {
                ...
                VexViewAPI.removeHUD(p, 2 + indexOf);
                VexTextShow vTitle = new VexTextShow(2 + indexOf, ConfigManager.getConfig().getInt("ui.hud.title.x") + ConfigManager.getConfig().getInt("ui.hud.x")
