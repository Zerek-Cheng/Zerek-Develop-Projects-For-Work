...
public class DynmapResidencePlugin extends JavaPlugin {
    ...
    private void updateResidence() {
        ...
        resmgr = Residence.getInstance().getResidenceManager(); /* Get residence manager */
        rentmgr = Residence.getInstance().getRentManager();
        transmgr = Residence.getInstance().getTransactionManager();
