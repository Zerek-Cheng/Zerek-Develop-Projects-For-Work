...
import cc.kunss.vexst.listeners.Close;
import cc.kunss.vexst.listeners.ExpChange;
import cc.kunss.vexst.listeners.Join;
import cc.kunss.vexst.listeners.ResultGuiClick;
import cc.kunss.vexst.listeners.VexSlotClick;
import cc.kunss.vexst.utils.AdvancedLicense;
import cc.kunss.vexst.utils.Methods;
import cc.kunss.vexst.utils.Placeholders;
import cc.kunss.vexst.utils.PlayerPointAPIs;
import cc.kunss.vexst.utils.VaultAPI;
...
public class Main
    ...
    public void onEnable() {
        ...
        Methods.Default();
        AdvancedLicense al = new AdvancedLicense(this.getConfig().getString(""), "", (Plugin) this);
        if (!al.register()) {
            return;
        }
